...
import { FormGroup, FormControlLabel, Switch, Stack, Container } from '@mui/material';
export const App = () => {
  const [enableBids, setEnableBids] = useReplicant<boolean>('omnibarEnableBids', false);
  const [enableMilestones, setEnableMilestones] = useReplicant<boolean>(
        ...
        <Stack spacing={2}>
          <FormGroup>
            <FormControlLabel
              control={
                <Switch
                  checked={enableBids}
                  onChange={(event) => {
                    setEnableBids(event.target.checked);
                  }}
                />
              }
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={(event) => {
                    setEnableMilestones(event.target.checked);
                  }}
                />
              }
            ...
            <FormControlLabel
              control={
                <Switch
                  checked={enableNextRuns}
                  onChange={(event) => {
                    setEnableNextRuns(event.target.checked);
                  }}
                />
              }
            ...
            <FormControlLabel
              control={
                <Switch
                  checked={enablePrizes}
                  onChange={(event) => {
                    setEnablePrizes(event.target.checked);
                  }}
                />
              }
            ...
            <FormControlLabel
              control={
                <Switch
                  checked={enableTotal}
                  onChange={(event) => {
                    setEnableTotal(event.target.checked);
                  }}
                />
              }
