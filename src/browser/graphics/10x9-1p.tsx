...
import layoutBg from './img/layouts/10x9-1p.png';
import layoutBgWithDonationBar from './img/layouts/10x9-1p-donationbar.png';
...
const Info = styled.div<{ showDonationBar: boolean }>`
  width: ${(props) => (props.showDonationBar ? '820px' : '772px')};
  height: 630px;
  position: fixed;
  top: 396px;
  text-align: center;
