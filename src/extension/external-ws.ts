...
const nodecg = get();
const logger = new TaggedLogger('External WS');
const OBSconfig = nodecg.bundleConfig.obs;
const externalWSConfig = nodecg.bundleConfig.externalWS;

if (externalWSConfig.enabled) {
  ...
  /* eslint-disable no-alert, no-inner-declarations */
