<template>
    <div id="container">
        <img id="Background" src="../img/layouts/standard_3.png" />
            ...
            <div v-if="activeRun.teams[0]" id="team1">
                ...
                <transition name="fade">
                    <finish-time
                        ...
                        :time="
                            timer.teamFinishTimes[activeRun.teams[0].id].time
                        "
                    />
                </transition>
            </div>
            <div v-if="activeRun.teams[1]" id="team2">
                ...
                <transition name="fade">
                    <finish-time
                        ...
                        :time="
                            timer.teamFinishTimes[activeRun.teams[1].id].time
                        "
                    />
                </transition>
            </div>
            <div v-if="activeRun.teams[2]" id="team3">
                ...
                <transition name="fade">
                    <finish-time
                        ...
                        :time="
                            timer.teamFinishTimes[activeRun.teams[2].id].time
                        "
                    />
                </transition>
            </div>
