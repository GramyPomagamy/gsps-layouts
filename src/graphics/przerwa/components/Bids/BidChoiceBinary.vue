  ...
  export default {
    ...
    methods: {
      ...
      animate() {
        ...
        tl.call(
          () => {
            document.getElementById('winningOptionAmount').innerText =
              this.bid.options[0].rawTotal.toLocaleString('en-US', {
                maximumFractionDigits: 0,
                useGrouping: false,
              }) + ' PLN';
            document.getElementById('losingOptionAmount').innerText =
              this.bid.options[1].rawTotal.toLocaleString('en-US', {
                maximumFractionDigits: 0,
                useGrouping: false,
              }) + ' PLN';
          },
        ...
        tl.to(proxy, 1, {
          ...
          onStart() {
            ...
            document.getElementById('winningOptionName').innerText =
              this.bid.options[0].name || this.bid.options[0].description;
            document.getElementById('losingOptionName').innerText =
              this.bid.options[1].name || this.bid.options[1].description;
          },
          onUpdate() {
