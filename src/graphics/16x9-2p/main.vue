<template>
  <div id="container">
    ...
    <div v-if="activeRun" id="runners">
      <!-- coop run -->
      <template v-if="activeRun.teams.length == 1">
        <div v-if="activeRun.teams[0]" id="team1">
          <template v-for="(player, index) in activeRun.teams[0].players">
            <player
              v-if="index % 2 == 0"
              :key="player.id"
              class="Player"
        ...
        <div v-if="activeRun.teams[0]" id="team2">
          <template v-for="(player, index) in activeRun.teams[0].players">
            <player
              v-if="index % 2 != 0"
              :key="player.id"
          ...
          <reader-name
            v-if="activeRun.teams[0].players.length > 1 && reader"
            id="reader"
          />
        </div>
      </template>
          ...
          <transition name="fade">
            <finish-time
              v-if="
                ...
                timer.teamFinishTimes[activeRun.teams[0].id].state ===
                  'completed'
              "
              :style="{
                left: '589px',
          ...
          <transition name="fade">
            <finish-time
              v-if="
                ...
                timer.teamFinishTimes[activeRun.teams[1].id].state ===
                  'completed'
              "
              :style="{
                right: '758px',
